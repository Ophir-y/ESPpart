...
//TODO description
const byte SECRET_PICC_MIFARE_CLASSIC[6] = { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };
...
const byte SECRET_PICC_MASTER_KEY[16] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x11};
//const byte SECRET_PICC_MASTER_KEY[24] = { 0 };
...
const byte SECRET_APPLICATION_KEY[16] = { 0 };
...
const byte SECRET_STORE_VALUE_KEY[16] = {0};
...
const byte CARD_KEY_VERSION = 0x0;
